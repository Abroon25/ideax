...
export default function Search() {
  ...
  var handleSearch = async function(searchQuery) {
      ...
      <main className="w-full max-w-[600px] border-x border-dark-700 min-h-screen">
        ...
        <div className="sticky top-0 z-30 bg-dark-950/80 backdrop-blur-md border-b border-dark-700 p-4">
          <div className="flex items-center gap-3">
            <button onClick={function() { navigate(-1); }} className="p-2 hover:bg-dark-800 rounded-full">
          ...
          {searched && (
            <div className="flex mt-3">
              <button onClick={function() { setActiveTab('ideas'); }}
              ...
              <button onClick={function() { setActiveTab('users'); }}
        ...
        {!searched && !loading && (
          <div className="py-20 text-center">
            <HiMagnifyingGlass className="w-16 h-16 text-dark-600 mx-auto mb-4" />
